...
public class AS extends CoapServer implements AutoCloseable{
	...
	public AS(AS_Params parameters) throws Exception{
		...
		//this.db = new CoapDBConnector(this.parameters.get_dburl(),
			//	this.parameters.get_dbuser(),
				//this.parameters.get_dbpwd());
		...
		discovery_server = new Discovery_Server(this.authorization_mode, 
				this.parameters.config_endpoint_resource,
