...
public class Coap_Discovery extends CoapServer{
	private static final int COAP_PORT = NetworkConfig.getStandard().getInt(NetworkConfig.Keys.COAP_PORT);
	private String rsid;
	
	private String tokenendpoint;
	private String asid;
	private String rsinfoendpoint;
	
	public Coap_Discovery(String rsid, String asid, String rsinfoendpoint,  String tokenendpoint) {
		this.rsid = rsid;
		this.asid = asid;
		this.rsinfoendpoint = rsinfoendpoint;
	...
	class Info extends CoapResource {
		...
		public Info() {
			...
			getAttributes().addAttribute("rsinfoendpoint", rsinfoendpoint);
